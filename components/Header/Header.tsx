    ...
    <>
      ...
      <div className="py-8 ">
        <Wrapper className=" flex items-center justify-between px-3 ">
          ...
          <div>
            <div className="xsm:flex gap-[24px] items-center hidden">
              ...
              <div className="flex gap-[16px] items-center">
                ...
                {userInfo && (
                  <Link href="/">
                    <span className="h-[32px] w-[32px] -mt-2  hover:bg-carminePink rounded-full flex items-center justify-center">
          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                <motion.div
                  className="flex flex-col gap-8 mt-36"
                  variants={{
                    open: {
                ...
                >
                  ...
                  <motion.div
                    className="flex xsm:hidden gap-8 px-4 py-3"
                    variants={{
                      open: {
                        opacity: 1,
