...
import JustForYouItems from "./JustForYouItem";
  ...
  return (
    <Wrapper className="py-14">
      <div className="h-auto gap-[180px] flex flex-col justify-between">
        ...
        <div className="w-full h-[40px]  flex items-center gap-4">
          <span className="w-[20px] h-[40px] bg-carminePink rounded-sm" />
          <p
            className={`${poppins.className} text-[20px] leading-[26px] text-black font-normal`}
          >
            Just For You
          </p>
        </div>
        ...
        <div className="flex items-center justify-center">
          <div className="h-auto lgl:h-[350px] w-full grid grid-cols-1 sm:grid-cols-2 lgl:grid-cols-4 justify-items-center">
            {JustForYouItems.map((item, index) => (
              <div
                key={index}
                className="w-[270px] h-[370px] gap-4 flex flex-col relative justify-between group"
              >
                <div className="h-[250px] w-full bg-secondary group mt-4 flex items-center justify-center relative">
                  <Image
                    src={item.image}
                    alt="Products"
                    className="w-[180px] h-[150px]"
                    ...
                    height={150}
                  />
                  <div className="h-[34px] w-[34px] flex items-center justify-center bg-white rounded-full absolute top-[10px] cursor-pointer right-[12px]">
                    <span className="w-[16px] h-[18px]">
                      <svg
                        width="18"
                        height="20"
