...
import { ReactivateOrderModal } from "./ReactivateOrderModal";

const poppins = Poppins({ subsets: ["latin"], weight: ["400", "700"] });

interface CancelledOrderSummaryProps {
  data: OrderData;
}

export default function OrderSummary({ data }: CancelledOrderSummaryProps) {
