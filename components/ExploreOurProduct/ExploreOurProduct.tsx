            ...
            {ProductsItems.map((item, index) => (
              ...
              >
                <div className="w-full h-[250px] bg-secondary relative cursor-pointer flex items-center justify-center">
                  ...
                  />
                  {item.isNew && (
                    <div className="w-[51px] absolute rounded-[4px] flex items-center top-[12px] left-3   h-[26px] bg-greenColor py-[4px] px-3">
                      <span
                ...
                {item.showDots && (
                  <div className="w-[48px] h-[20px]  flex gap-2 items-center">
                    <div className="h-[20px] w-[20px] border-[2px] border-black flex items-center justify-center  rounded-full">
                      <span className="h-[16px] w-[16px] rounded-full bg-[#FB1314] " />
                    </div>
                    <span className="h-[20px] w-[20px] bg-carminePink rounded-full" />
                  </div>
                )}
              </div>
            ))}
