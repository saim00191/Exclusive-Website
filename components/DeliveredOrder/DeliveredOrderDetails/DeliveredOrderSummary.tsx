...
import DeliveredImg from "@/images/Delivered.png";
...
export default function OrderSummary({ data }: DeliveredOrderSummaryProps) {
  ...
  return (
    ...
    <div className="h-full rounded-[4px] border-black border-[1.5px] px-4 w-full sm:w-[470px] flex flex-col items-center">
