          ...
          data.map((order) => (
            <div className="py-8 space-y-6 px-2" key={order.orderId}>
              ...
              <div className="max-w-[700px] h-auto flex flex-col gap-2 sml:flex-row sml:gap-3 justify-between items-start sml:items-center">
                <p className={`${inter.className} text-[#667085] font-medium text-[20px] leading-[26px]`}>
                  Order Date:{" "}
                ...
                <p className={`${inter.className} text-[#12B76A] font-medium text-[20px] leading-[26px]`}>
                  Delivery Date:{" "}
                  <span className={`${poppins.className} font-medium text-black`}>
              ...
              <div>
                {order.products.map((item) => (
                  ...
                  >
                    ...
                    <p className={`${poppins.className} text-black justify-end smxs:justify-start flex items-center`}>
                      {item.productName}
                    </p>
                    ...
                    <p className={`${poppins.className} text-black flex justify-end items-center`}>
                      ${item.totalPrice}
                    </p>
                  </div>
                ))}
